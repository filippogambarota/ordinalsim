...
\NormalTok{  latl }\OtherTok{\textless{}{-}} \FunctionTok{pivot\_longer}\NormalTok{(latl, }\FunctionTok{starts\_with}\NormalTok{(}\StringTok{"y"}\NormalTok{), }\AttributeTok{names\_to =} \StringTok{"y"}\NormalTok{, }\AttributeTok{values\_to =} \StringTok{"value"}\NormalTok{)}
