...
\NormalTok{odds }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(p) p }\SpecialCharTok{/}\NormalTok{ (}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ p) }\CommentTok{\# function to compute odds}

\CommentTok{\# group a}
\NormalTok{a\_or1vs2345 }\OtherTok{\textless{}{-}} \FunctionTok{odds}\NormalTok{(pr[}\DecValTok{1}\NormalTok{, }\DecValTok{1}\NormalTok{]) }\CommentTok{\# 1 vs 2 3 4 5}
\NormalTok{a\_or12vs345 }\OtherTok{\textless{}{-}} \FunctionTok{odds}\NormalTok{(}\FunctionTok{sum}\NormalTok{(pr[}\DecValTok{1}\NormalTok{, }\DecValTok{1}\SpecialCharTok{:}\DecValTok{2}\NormalTok{])) }\CommentTok{\# 1 vs 2 3 4 5}

\CommentTok{\# group b}
\NormalTok{b\_or1vs2345 }\OtherTok{\textless{}{-}} \FunctionTok{odds}\NormalTok{(pr[}\DecValTok{2}\NormalTok{, }\DecValTok{1}\NormalTok{]) }\CommentTok{\# 1 vs 2 3 4 5}
\NormalTok{b\_or12vs345 }\OtherTok{\textless{}{-}} \FunctionTok{odds}\NormalTok{(}\FunctionTok{sum}\NormalTok{(pr[}\DecValTok{2}\NormalTok{, }\DecValTok{1}\SpecialCharTok{:}\DecValTok{2}\NormalTok{])) }\CommentTok{\# 1 vs 2 3 4 5}
...
\CommentTok{\# group a}
\NormalTok{a\_1vs2345 }\OtherTok{\textless{}{-}} \FunctionTok{qnorm}\NormalTok{(pr[}\DecValTok{1}\NormalTok{, }\DecValTok{1}\NormalTok{]) }\CommentTok{\# 1 vs 2 3 4 5}
\NormalTok{a\_12vs345 }\OtherTok{\textless{}{-}} \FunctionTok{qnorm}\NormalTok{(}\FunctionTok{sum}\NormalTok{(pr[}\DecValTok{1}\NormalTok{, }\DecValTok{1}\SpecialCharTok{:}\DecValTok{2}\NormalTok{])) }\CommentTok{\# 1 2 vs 3 4 5}

\CommentTok{\# group b}
\NormalTok{b\_1vs2345 }\OtherTok{\textless{}{-}} \FunctionTok{qnorm}\NormalTok{(pr[}\DecValTok{2}\NormalTok{, }\DecValTok{1}\NormalTok{]) }\CommentTok{\# 1 vs 2 3 4 5}
\NormalTok{b\_12vs345 }\OtherTok{\textless{}{-}} \FunctionTok{qnorm}\NormalTok{(}\FunctionTok{sum}\NormalTok{(pr[}\DecValTok{2}\NormalTok{, }\DecValTok{1}\SpecialCharTok{:}\DecValTok{2}\NormalTok{])) }\CommentTok{\# 1 2 vs 3 4 5}

\FunctionTok{c}\NormalTok{(}\AttributeTok{xa =}\NormalTok{ a\_1vs2345 }\SpecialCharTok{{-}}\NormalTok{ a\_12vs345, }\AttributeTok{xb =}\NormalTok{ b\_1vs2345 }\SpecialCharTok{{-}}\NormalTok{ b\_12vs345)}
\end{Highlighting}
\end{Shaded}
...
\subsubsection{Beyond the proportional odds}\label{beyond-the-proportional-odds}
