...
p2 <- show_alpha(prob = c(0.1, 0.2, 0.5, 0.2), link = "probit", plot = c("latent", "probs"))
...
```{r fig-effects-2-by-2-interaction}
...
```{r fig-effects-num-by-cat-interaction}
...
```{r fig-power-curve, fig.cap=filor::get_caption()}
