...
In this tutorial we presented the CM model in terms of model fitting, parameters interpretation and data simulation. The basic model can be expanded in several ways. When assuming PO or considering only a location effect is limiting, including scale (*location-scale*), thresholds (*location-shift*) effects or relaxing the PO assumption can help in modeling complex phenomenon. The supplementary materials ([https://osf.io/93h5j](https://osf.io/93h5j/?view_only=33f262ee28374a88b935f0a25cefdb34)) contains some examples of these complex models. Furtermore, with clustered data (e.g., multiple items/repetitions for the same participant), a random-effect CM model can be fitted including random intercepts and slopes.
